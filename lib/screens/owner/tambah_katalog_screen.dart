...
class TambahKatalogScreen extends StatefulWidget {
  ...
  @override
  State<TambahKatalogScreen> createState() => _TambahKatalogScreenState();
}
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Data katalog baru telah disimpan!',
                  textAlign: TextAlign.center,
                  style: GoogleFonts.inter(
                    fontSize: 13,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.pop(context); // kembali ke Kelola
                  },
