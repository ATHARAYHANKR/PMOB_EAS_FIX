...
class FirestoreService {
  ...
  static final List<Map<String, dynamic>> _localKatalog = [
    {'id': 'cuci_kering_regular', 'nama': 'Cuci Kering Regular', 'satuan': 'Kg', 'harga': 7000, 'estimasi': '2 hari', 'deskripsi': 'Cuci kering standar dengan waktu pengerjaan normal.', 'aktif': true},
    {'id': 'cuci_kering_express', 'nama': 'Cuci Kering Express', 'satuan': 'Kg', 'harga': 12000, 'estimasi': '1 hari', 'deskripsi': 'Cuci kering cepat dengan prioritas pengerjaan.', 'aktif': true},
    {'id': 'cuci_setrika_regular', 'nama': 'Cuci Setrika Regular', 'satuan': 'Kg', 'harga': 10000, 'estimasi': '3 hari', 'deskripsi': 'Cuci dan setrika standar dengan waktu pengerjaan normal.', 'aktif': true},
    {'id': 'cuci_setrika_express', 'nama': 'Cuci Setrika Express', 'satuan': 'Kg', 'harga': 15000, 'estimasi': '1 hari', 'deskripsi': 'Cuci dan setrika cepat dengan prioritas pengerjaan.', 'aktif': true},
    {'id': 'setrika_saja_regular', 'nama': 'Setrika Saja Regular', 'satuan': 'Kg', 'harga': 5000, 'estimasi': '1 hari', 'deskripsi': 'Setrika saja standar untuk pakaian bersih.', 'aktif': true},
    {'id': 'setrika_saja_express', 'nama': 'Setrika Saja Express', 'satuan': 'Kg', 'harga': 8000, 'estimasi': '6 jam', 'deskripsi': 'Setrika saja cepat dengan prioritas pengerjaan.', 'aktif': true},
    {'id': 'laundry_sepatu_regular', 'nama': 'Laundry Sepatu Regular', 'satuan': 'Pasang', 'harga': 18000, 'estimasi': '2 hari', 'deskripsi': 'Layanan cuci sepatu standar dengan waktu pengerjaan normal.', 'aktif': true},
    {'id': 'laundry_sepatu_express', 'nama': 'Laundry Sepatu Express', 'satuan': 'Pasang', 'harga': 27000, 'estimasi': '1 hari', 'deskripsi': 'Layanan cuci sepatu cepat dengan prioritas pengerjaan.', 'aktif': true},
    {'id': 'laundry_tas_regular', 'nama': 'Laundry Tas Regular', 'satuan': 'Pcs', 'harga': 25000, 'estimasi': '3 hari', 'deskripsi': 'Cuci tas kain, kanvas, dan ransel standar.', 'aktif': true},
    {'id': 'laundry_tas_express', 'nama': 'Laundry Tas Express', 'satuan': 'Pcs', 'harga': 38000, 'estimasi': '1 hari', 'deskripsi': 'Cuci tas kain, kanvas, dan ransel dengan prioritas cepat.', 'aktif': true},
    {'id': 'cuci_karpet_regular', 'nama': 'Cuci Karpet Regular', 'satuan': 'M2', 'harga': 15000, 'estimasi': '3 hari', 'deskripsi': 'Cuci karpet bersih dengan deterjen khusus karpet.', 'aktif': true},
    {'id': 'cuci_karpet_express', 'nama': 'Cuci Karpet Express', 'satuan': 'M2', 'harga': 22000, 'estimasi': '1 hari', 'deskripsi': 'Cuci karpet cepat dengan pengeringan khusus.', 'aktif': true},
    {'id': 'cuci_boneka_regular', 'nama': 'Cuci Boneka Regular', 'satuan': 'Pcs', 'harga': 20000, 'estimasi': '2 hari', 'deskripsi': 'Cuci boneka plush dan stuffed toy standar dengan aman.', 'aktif': true},
    {'id': 'cuci_boneka_express', 'nama': 'Cuci Boneka Express', 'satuan': 'Pcs', 'harga': 30000, 'estimasi': '1 hari', 'deskripsi': 'Cuci boneka cepat dengan pengeringan dan perawatan khusus.', 'aktif': true},
    {'id': 'cuci_jas_regular', 'nama': 'Cuci Jas Regular', 'satuan': 'Pcs', 'harga': 35000, 'estimasi': '3 hari', 'deskripsi': 'Cuci dan setrika jas, blazer, dan pakaian formal standar.', 'aktif': true},
    {'id': 'cuci_jas_express', 'nama': 'Cuci Jas Express', 'satuan': 'Pcs', 'harga': 50000, 'estimasi': '1 hari', 'deskripsi': 'Cuci dan setrika jas dan pakaian formal dengan prioritas cepat.', 'aktif': true},
    {'id': 'cuci_bedcover_regular', 'nama': 'Cuci Bed Cover Regular', 'satuan': 'Pcs', 'harga': 30000, 'estimasi': '3 hari', 'deskripsi': 'Cuci bed cover, selimut, dan sprei ukuran besar standar.', 'aktif': true},
    {'id': 'cuci_bedcover_express', 'nama': 'Cuci Bed Cover Express', 'satuan': 'Pcs', 'harga': 45000, 'estimasi': '1 hari', 'deskripsi': 'Cuci bed cover dan selimut cepat dengan pengeringan optimal.', 'aktif': true},
    {'id': 'paket_hemat_5kg', 'nama': 'Paket Hemat 5 Kg', 'satuan': 'Paket', 'harga': 30000, 'estimasi': '2 hari', 'deskripsi': 'Paket cuci kering ekonomis untuk 5 kg pakaian, hemat lebih dari harga satuan.', 'aktif': true},
    {'id': 'paket_hemat_10kg', 'nama': 'Paket Hemat 10 Kg', 'satuan': 'Paket', 'harga': 55000, 'estimasi': '2 hari', 'deskripsi': 'Paket cuci kering ekonomis untuk 10 kg pakaian, harga paling terjangkau per kg.', 'aktif': true},
  ];
